...
ActiveRecord::Schema[8.0].define(version: 2025_09_10_172000) do
  ...
  create_table "bills", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "project_id"], name: "index_bills_on_account_id_and_project_id"
  ...
  create_table "line_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "package_id"], name: "index_line_items_on_account_id_and_package_id"
  ...
  create_table "packages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "bill_id"], name: "index_packages_on_account_id_and_bill_id"
    t.index ["account_id"], name: "index_packages_on_account_id"
    t.index ["bill_id"], name: "index_packages_on_bill_id"
  end
  ...
  add_foreign_key "packages", "accounts"
  add_foreign_key "packages", "bills"
